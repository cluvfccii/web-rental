        ...
        <form action='aksi_edit_transaksi.php?id=<?php echo "id_transaksi"; ?>' method='POST'>
            <table border="0">
                <tr>
                    <td>id_transaksi</td>
                <tr>
                    <td><input name='id_transaksi' type='text' id="id_transaksi"
                            value="<?php echo $data['id_transaksi'] ?>"></td>
                </tr>
                <tr>
                    <td>id_mobil</td>
                <tr>
                ...
                <tr>
                    <td>id_customer</td>
                <tr>
                    <td><input name='id_customer' type='text' id="id_customer"
                            value="<?php echo $data['id_customer'] ?>"></td>
                </tr>
                <tr>
                    <td>tgl_sewa</td>
                <tr>
                ...
                <tr>
                    <td><input name='tgl_kembali' type='text' id="tgl_kembali"
                            value="<?php echo $data['tgl_kembali'] ?>"></td>
                </tr>
